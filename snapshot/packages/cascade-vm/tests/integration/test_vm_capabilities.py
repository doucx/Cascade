...
from cascade.vm.middleware.standard import ArgumentResolutionMiddleware, RetryMiddleware
...
async def test_vm_resolves_context_operands():
    ...
    vm.set_middlewares([ArgumentResolutionMiddleware(active_resources, global_context)])
