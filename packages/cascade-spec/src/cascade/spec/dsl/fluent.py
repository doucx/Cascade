...
class LazyResult(Generic[T]):
    ...
    _cache_policy: Any | None = None  # CachePolicy
    _condition: LazyResult | None = None
    _constraints: Any | None = None  # ResourceConstraint
    _dependencies: list[LazyResult] = field(default_factory=list)  # Explicit sequencing
    _jump_selector: Any | None = None  # Explicit Control Flow (JumpSelector)
